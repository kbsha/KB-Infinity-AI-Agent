...
You can:
- Read files using read_note
- Write files using write_note

Rules:
- If the user asks to write a file, call write_note exactly once.
- After writing, STOP and return the result.
- Do NOT call tools multiple times.
- Do NOT loop.
- Always finish after completing the task.
"""
...
# print(run_agent("Write a note to 'meeting_notes.txt' with the content 'Meeting at 3 PM on Friday.'"))
